...
class Deck
{
    ...
    public static ArrayList<Integer> arylst = new ArrayList<Integer>();
    public static ArrayList<Integer> shuffledList = new ArrayList<Integer>();
    public static ArrayList<Integer> h1 = new ArrayList<Integer>();
    public static ArrayList<Integer> h2 = new ArrayList<Integer>();
    public static ArrayList<Integer> h3 = new ArrayList<Integer>();
    public static ArrayList<Integer> h4 = new ArrayList<Integer>();
    public static ArrayList<Integer> h5 = new ArrayList<Integer>();
    ...
    public static void main (String[] args) 
    {
        ...
        System.out.println(Deal(players));
    }
}